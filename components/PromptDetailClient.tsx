...
import { ChevronRight, MessageSquare, Heart, Bookmark, Share2, ZoomIn } from 'lucide-react';
    ...
    <div style={{ position: 'relative', minHeight: '100vh', paddingBottom: '120px' }}>
      <div className="animate-reveal">
        <div className="site-container">
          ...
          {/* 2. IMAGE SECTION - Cinematic Glassmorphic Frame */}
          <div
            className="cinematic-frame"
            onClick={() => setIsLightboxOpen(true)}
            style={{
              position: 'relative', width: '100%', height: 'clamp(400px, 60vh, 650px)',
              borderRadius: '24px', overflow: 'hidden', boxShadow: 'var(--shadow-lg)',
              marginBottom: '40px', cursor: 'zoom-in', backgroundColor: 'var(--color-bg)'
            }}
          >
            {/* ATMOSPHERIC BACKDROP */}
            <div style={{ position: 'absolute', inset: -20, filter: 'blur(20px) brightness(0.7)' }}>
              <Image
                src={prompt.imageUrl}
                alt=""
                fill
            ...
            {/* PURE ASSET FOREGROUND */}
            <Image
              src={prompt.imageUrl}
              alt={prompt.title}
              fill
              style={{ objectFit: 'contain', zIndex: 1, padding: 'var(--detail-img-padding, 24px)' }}
              priority
            />
            ...
            <div style={{
              ...
              letterSpacing: '0.1em', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', zIndex: 10
            }}>
              RESULT
            </div>
